...
var Default = function Default() {
  ...
  return _ref = {
    ...
    "fontOpacity": [{ "label": "25%", "value": ".25" }, { "label": "50%", "value": ".5" }, { "label": "75%", "value": ".75" }, { "label": "100%", "value": "1" }],
    ...
    "backgroundOpacity": [{ label: "0%", value: "0" }, { label: "25%", value: ".25" }, { label: "50%", value: ".5" }, { label: "75%", value: ".75" }, { label: "100%", value: "1" }],
  ...
  }, babelHelpers.defineProperty(_ref, "fontOpacity", [{ label: "25%", value: ".25" }, { label: "50%", value: ".5" }, { label: "75%", value: ".75" }, { label: "100%", value: "1" }]), babelHelpers.defineProperty(_ref, "scroll", [{ label: "Pop-out", value: "popout" }, { label: "Roll-on", value: "rollon" }, { label: "Paint-on", value: "painton" }]), babelHelpers.defineProperty(_ref, "windowColor", [{ label: "White", value: new Color(255, 255, 255) }, { label: "Yellow", value: new Color(255, 255, 0) }, { label: "Green", value: new Color(0, 128, 0) }, { label: "Cyan", value: new Color(0, 255, 255) }, { label: "Blue", value: new Color(0, 0, 255) }, { label: "Magenta", value: new Color(255, 0, 255) }, { label: "Red", value: new Color(255, 0, 0) }, { label: "Black", value: new Color(0, 0, 0) }]), babelHelpers.defineProperty(_ref, "windowOpacity", [{ label: "0%", value: "0" }, { label: "25%", value: ".25" }, { label: "50%", value: ".5" }, { label: "75%", value: ".75" }, { label: "100%", value: "1" }]), _ref;
};
...
var CaptionSettings = function (_Panel) {
  ...
  function CaptionSettings(props, context) {
    ...
    _this.state.labels = new Default();
  ...
  babelHelpers.createClass(CaptionSettings, [{
    ...
    value: function initSettingLabels() {
      for (var key in this.state.labels) {
        ...
        try {
          for (var _iterator = this.state.labels[key][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var item = _step.value;

            if (/color/i.test(key) && item.value.r == this.state.captionsettings[key].r && item.value.g == this.state.captionsettings[key].g && item.value.b == this.state.captionsettings[key].b || /opacity/i.test(key) && item.value == this.state.captionsettings[key.replace("Opacity", "Color")].a || this.state.captionsettings[key] == item.value) {
